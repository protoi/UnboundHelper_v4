...
#pragma region move effect mapping

	const char *move_effect_mapping[] = {
		[EFFECT_ATTACK_DOWN_HIT] = "ATTACK_DOWN_HIT",
		[EFFECT_LAST_RESORT] = "LAST_RESORT",
		[EFFECT_CONVERSION_2] = "CONVERSION_2",
		[EFFECT_SKILL_SWAP] = "SKILL_SWAP",
		[EFFECT_SLEEP] = "SLEEP",
		[EFFECT_LIGHT_SCREEN] = "LIGHT_SCREEN",
		[EFFECT_REMOVE_TARGET_STAT_CHANGES] = "REMOVE_TARGET_STAT_CHANGES",
		[EFFECT_REFRESH] = "REFRESH",
		[EFFECT_STAT_SWAP_SPLIT] = "STAT_SWAP_SPLIT",
		[EFFECT_RAGE] = "RAGE",
		[EFFECT_NATURAL_GIFT] = "NATURAL_GIFT",
		[EFFECT_GRUDGE] = "GRUDGE",
		[EFFECT_RECOIL_IF_MISS] = "RECOIL_IF_MISS",
		[EFFECT_WATER_SPORT] = "WATER_SPORT",
		[EFFECT_RAZOR_WIND] = "RAZOR_WIND",
		[EFFECT_RECHARGE] = "RECHARGE",
		[EFFECT_HELPING_HAND] = "HELPING_HAND",
		[EFFECT_SUPERPOWER] = "SUPERPOWER",
		[EFFECT_SPLASH] = "SPLASH",
		[EFFECT_LOCK_ON] = "LOCK_ON",
		[EFFECT_PARALYZE] = "PARALYZE",
		[EFFECT_TWISTER] = "TWISTER",
		[EFFECT_BURN_HIT] = "BURN_HIT",
		[EFFECT_RAPID_SPIN] = "RAPID_SPIN",
		[EFFECT_QUICK_ATTACK] = "QUICK_ATTACK",
		[EFFECT_MUD_SPORT] = "MUD_SPORT",
		[EFFECT_ACCURACY_DOWN_HIT] = "ACCURACY_DOWN_HIT",
		[EFFECT_DEFENSE_DOWN_2] = "DEFENSE_DOWN_2",
		[EFFECT_BAD_POISON_HIT] = "BAD_POISON_HIT",
		[EFFECT_TRAP] = "TRAP",
		[EFFECT_DRAGON_DANCE] = "DRAGON_DANCE",
		[EFFECT_EVASION_DOWN_2] = "EVASION_DOWN_2",
		[EFFECT_SNORE] = "SNORE",
		[EFFECT_RECYCLE] = "RECYCLE",
		[EFFECT_HAZE] = "HAZE",
		[EFFECT_DESTINY_BOND] = "DESTINY_BOND",
		[EFFECT_SWALLOW] = "SWALLOW",
		[EFFECT_HIGH_CRITICAL] = "HIGH_CRITICAL",
		[EFFECT_SMACK_DOWN] = "SMACK_DOWN",
		[EFFECT_DEFENSE_UP_HIT] = "DEFENSE_UP_HIT",
		[EFFECT_GUST] = "GUST",
		[EFFECT_CONFUSE_HIT] = "CONFUSE_HIT",
		[EFFECT_SPECIAL_DEFENSE_DOWN_2_HIT] = "SPECIAL_DEFENSE_DOWN_2_HIT",
		[EFFECT_FLINCH_HIT] = "FLINCH_HIT",
		[EFFECT_TOXIC] = "TOXIC",
		[EFFECT_CHARGE] = "CHARGE",
		[EFFECT_ATTACK_DOWN_2] = "ATTACK_DOWN_2",
		[EFFECT_MEMENTO] = "MEMENTO",
		[EFFECT_SPEED_DOWN] = "SPEED_DOWN",
		[EFFECT_WILL_O_WISP] = "WILL_O_WISP",
		[EFFECT_DREAM_EATER] = "DREAM_EATER",
		[EFFECT_NATURE_POWER] = "NATURE_POWER",
		[EFFECT_TRICK] = "TRICK",
		[EFFECT_SPECIAL_DEFENSE_DOWN_2] = "SPECIAL_DEFENSE_DOWN_2",
		[EFFECT_BELLY_DRUM] = "BELLY_DRUM",
		[EFFECT_THIEF] = "THIEF",
		[EFFECT_YAWN] = "YAWN",
		[EFFECT_ATTACK_UP_HIT] = "ATTACK_UP_HIT",
		[EFFECT_KNOCK_OFF] = "KNOCK_OFF",
		[EFFECT_CALM_MIND] = "CALM_MIND",
		[EFFECT_IMPRISON] = "IMPRISON",
		[EFFECT_EXTREME_EVOBOOST] = "EXTREME_EVOBOOST",
		[EFFECT_SPECIAL_DEFENSE_UP] = "SPECIAL_DEFENSE_UP",
		[EFFECT_EAT_BERRY] = "EAT_BERRY",
		[EFFECT_FREEZE_HIT] = "FREEZE_HIT",
		[EFFECT_METRONOME] = "METRONOME",
		[EFFECT_ATTACK_UP_2] = "ATTACK_UP_2",
		[EFFECT_ATK_SPATK_UP] = "ATK_SPATK_UP",
		[EFFECT_MAX_MOVE] = "MAX_MOVE",
		[EFFECT_DEFENSE_DOWN_HIT] = "DEFENSE_DOWN_HIT",
		[EFFECT_BEAT_UP] = "BEAT_UP",
		[EFFECT_ATTACK_DOWN] = "ATTACK_DOWN",
		[EFFECT_TORMENT] = "TORMENT",
		[EFFECT_TAUNT] = "TAUNT",
		[EFFECT_SPITE] = "SPITE",
		[EFFECT_COUNTER] = "COUNTER",
		[EFFECT_EVASION_UP] = "EVASION_UP",
		[EFFECT_SANDSTORM] = "SANDSTORM",
		[EFFECT_BIDE] = "BIDE",
		[EFFECT_SMELLINGSALT] = "SMELLINGSALT",
		[EFFECT_BULK_UP] = "BULK_UP",
		[EFFECT_PLAY_NICE] = "PLAY_NICE",
		[EFFECT_SET_TERRAIN] = "SET_TERRAIN",
		[EFFECT_SUNNY_DAY] = "SUNNY_DAY",
		[EFFECT_SKY_DROP] = "SKY_DROP",
		[EFFECT_PSYCH_UP] = "PSYCH_UP",
		[EFFECT_PAY_DAY] = "PAY_DAY",
		[EFFECT_FOCUS_ENERGY] = "FOCUS_ENERGY",
		[EFFECT_MAGNITUDE] = "MAGNITUDE",
		[EFFECT_SPIT_UP] = "SPIT_UP",
		[EFFECT_SPECIAL_DEFENSE_UP_2] = "SPECIAL_DEFENSE_UP_2",
		[EFFECT_ACCURACY_DOWN] = "ACCURACY_DOWN",
		[EFFECT_PRESENT] = "PRESENT",
		[EFFECT_TEAM_EFFECTS] = "TEAM_EFFECTS",
		[EFFECT_TELEPORT] = "TELEPORT",
		[EFFECT_REFLECT] = "REFLECT",
		[EFFECT_FALSE_SWIPE] = "FALSE_SWIPE",
		[EFFECT_FUTURE_SIGHT] = "FUTURE_SIGHT",
		[EFFECT_RECOIL] = "RECOIL",
		[EFFECT_ENCORE] = "ENCORE",
		[EFFECT_POISON] = "POISON",
		[EFFECT_TRI_ATTACK] = "TRI_ATTACK",
		[EFFECT_SPECIAL_ATTACK_DOWN] = "SPECIAL_ATTACK_DOWN",
		[EFFECT_SKETCH] = "SKETCH",
		[EFFECT_SPIKES] = "SPIKES",
		[EFFECT_HEAL_TARGET] = "HEAL_TARGET",
		[EFFECT_MORNING_SUN] = "MORNING_SUN",
		[EFFECT_ASSIST] = "ASSIST",
		[EFFECT_PARALYZE_HIT] = "PARALYZE_HIT",
		[EFFECT_ATTACK_UP] = "ATTACK_UP",
		[EFFECT_SUPER_FANG] = "SUPER_FANG",
		[EFFECT_TEATIME] = "TEATIME",
		[EFFECT_SLEEP_TALK] = "SLEEP_TALK",
		[EFFECT_HIT] = "HIT",
		[EFFECT_THUNDER] = "THUNDER",
		[EFFECT_FLING] = "FLING",
		[EFFECT_RAIN_DANCE] = "RAIN_DANCE",
		[EFFECT_FORESIGHT] = "FORESIGHT",
		[EFFECT_SPEED_UP_2] = "SPEED_UP_2",
		[EFFECT_RESTORE_HP] = "RESTORE_HP",
		[EFFECT_MINIMIZE] = "MINIMIZE",
		[EFFECT_CAMOUFLAGE] = "CAMOUFLAGE",
		[EFFECT_PLEDGE] = "PLEDGE",
		[EFFECT_EXPLOSION] = "EXPLOSION",
		[EFFECT_PURSUIT] = "PURSUIT",
		[EFFECT_DEF_SPD_UP] = "DEF_SPD_UP",
		[EFFECT_ALL_STATS_UP_HIT] = "ALL_STATS_UP_HIT",
		[EFFECT_DOUBLE_HIT] = "DOUBLE_HIT",
		[EFFECT_RAMPAGE] = "RAMPAGE",
		[EFFECT_HAIL] = "HAIL",
		[EFFECT_ATK_ACC_UP] = "ATK_ACC_UP",
		[EFFECT_RELIC_SONG] = "RELIC_SONG",
		[EFFECT_POISON_HIT] = "POISON_HIT",
		[EFFECT_MEAN_LOOK] = "MEAN_LOOK",
		[EFFECT_WISH] = "WISH",
		[EFFECT_SPRINGTIDE_STORM] = "SPRINGTIDE_STORM",
		[EFFECT_ROAR] = "ROAR",
		[EFFECT_BRICK_BREAK] = "BRICK_BREAK",
		[EFFECT_MIST] = "MIST",
		[EFFECT_DISABLE] = "DISABLE",
		[EFFECT_SKY_ATTACK] = "SKY_ATTACK",
		[EFFECT_FLATTER] = "FLATTER",
		[EFFECT_SUBSTITUTE] = "SUBSTITUTE",
		[EFFECT_SPLINTER] = "SPLINTER",
		[EFFECT_PSYWAVE] = "PSYWAVE",
		[EFFECT_ABSORB] = "ABSORB",
		[EFFECT_FAKE_OUT] = "FAKE_OUT",
		[EFFECT_CONVERSION] = "CONVERSION",
		[EFFECT_ME_FIRST] = "ME_FIRST",
		[EFFECT_CONFUSE] = "CONFUSE",
		[EFFECT_IGNORE_REDIRECTION] = "IGNORE_REDIRECTION",
		[EFFECT_SPECIAL_ATTACK_UP_2] = "SPECIAL_ATTACK_UP_2",
		[EFFECT_DEFENSE_CURL] = "DEFENSE_CURL",
		[EFFECT_TOPSY_TURVY_ELECTRIFY] = "TOPSY_TURVY_ELECTRIFY",
		[EFFECT_SAFEGUARD] = "SAFEGUARD",
		[EFFECT_FAIRY_LOCK_HAPPY_HOUR] = "FAIRY_LOCK_HAPPY_HOUR",
		[EFFECT_ROLLOUT] = "ROLLOUT",
		[EFFECT_TICKLE] = "TICKLE",
		[EFFECT_PERISH_SONG] = "PERISH_SONG",
		[EFFECT_POLTERGEIST] = "POLTERGEIST",
		[EFFECT_TRIPLE_KICK] = "TRIPLE_KICK",
		[EFFECT_MAGIC_COAT] = "MAGIC_COAT",
		[EFFECT_ENDEAVOR] = "ENDEAVOR",
		[EFFECT_SECRET_POWER] = "SECRET_POWER",
		[EFFECT_STOCKPILE] = "STOCKPILE",
		[EFFECT_DEFENSE_DOWN] = "DEFENSE_DOWN",
		[EFFECT_TRANSFORM] = "TRANSFORM",
		[EFFECT_DRAGON_RAGE] = "DRAGON_RAGE",
		[EFFECT_FURY_CUTTER] = "FURY_CUTTER",
		[EFFECT_HIGHER_OFFENSES_DEFENSES_UP_HIT] = "HIGHER_OFFENSES_DEFENSES_UP_HIT",
		[EFFECT_SPEED_DOWN_HIT] = "SPEED_DOWN_HIT",
		[EFFECT_INGRAIN] = "INGRAIN",
		[EFFECT_LEECH_SEED] = "LEECH_SEED",
		[EFFECT_SEMI_INVULNERABLE] = "SEMI_INVULNERABLE",
		[EFFECT_SWAGGER] = "SWAGGER",
		[EFFECT_SPECIAL_ATTACK_UP_HIT] = "SPECIAL_ATTACK_UP_HIT",
		[EFFECT_MIMIC] = "MIMIC",
		[EFFECT_SPECIAL_ATTACK_DOWN_HIT] = "SPECIAL_ATTACK_DOWN_HIT",
		[EFFECT_SNATCH] = "SNATCH",
		[EFFECT_COSMIC_POWER] = "COSMIC_POWER",
		[EFFECT_MULTI_HIT] = "MULTI_HIT",
		[EFFECT_0HKO] = "0HKO",
		[EFFECT_CURSE] = "CURSE",
		[EFFECT_REST] = "REST",
		[EFFECT_BURN_UP] = "BURN_UP",
		[EFFECT_LEVEL_DAMAGE] = "LEVEL_DAMAGE",
		[EFFECT_FLAIL] = "FLAIL",
		[EFFECT_SPEED_UP_1_HIT] = "SPEED_UP_1_HIT",
		[EFFECT_PAIN_SPLIT] = "PAIN_SPLIT",
		[EFFECT_NIGHTMARE] = "NIGHTMARE",
		[EFFECT_FOCUS_PUNCH] = "FOCUS_PUNCH",
		[EFFECT_FIELD_EFFECTS] = "FIELD_EFFECTS",
		[EFFECT_DAMAGE_SET_TERRAIN] = "DAMAGE_SET_TERRAIN",
		[EFFECT_FOLLOW_ME] = "FOLLOW_ME",
		[EFFECT_ALWAYS_HIT] = "ALWAYS_HIT",
		[EFFECT_ATTRACT] = "ATTRACT",
		[EFFECT_VENOM_DRENCH] = "VENOM_DRENCH",
		[EFFECT_DEFENSE_UP_2] = "DEFENSE_UP_2",
		[EFFECT_ATTACK_BLOCKERS] = "ATTACK_BLOCKERS",
		[EFFECT_MIRROR_COAT] = "MIRROR_COAT",
		[EFFECT_ROLE_PLAY] = "ROLE_PLAY",
		[EFFECT_OVERHEAT] = "OVERHEAT",
		[EFFECT_BATON_PASS] = "BATON_PASS",
		[EFFECT_DEFENSE_UP_2_HIT] = "DEFENSE_UP_2_HIT",
		[EFFECT_UPROAR] = "UPROAR",
		[EFFECT_SPECIAL_DEFENSE_DOWN_HIT] = "SPECIAL_DEFENSE_DOWN_HIT",
		[EFFECT_DEFENSE_UP] = "DEFENSE_UP",
		[EFFECT_SKULL_BASH] = "SKULL_BASH",
		[EFFECT_SUCKER_PUNCH] = "SUCKER_PUNCH",
		[EFFECT_MIRROR_MOVE] = "MIRROR_MOVE",
		[EFFECT_TYPE_CHANGES] = "TYPE_CHANGES",
		[EFFECT_SOLARBEAM] = "SOLARBEAM",
		[EFFECT_SPEED_DOWN_2] = "SPEED_DOWN_2",
		[EFFECT_INSTRUCT_AFTER_YOU_QUASH] = "INSTRUCT_AFTER_YOU_QUASH",
		[EFFECT_FEINT] = "FEINT",
		[EFFECT_HEAL_BELL] = "HEAL_BELL",
		[EFFECT_SONICBOOM] = "SONICBOOM",
		[EFFECT_PROTECT] = "PROTECT",
		[EFFECT_SPECIAL_ATTACK_DOWN_2] = "SPECIAL_ATTACK_DOWN_2",
		[EFFECT_FLAMEBURST] = "FLAMEBURST"};

#pragma endregion move effect mapping
